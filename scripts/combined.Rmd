...
library('zoo') #rollapply function for sliding windows; not necessary if you use funciton slide
...
for(i in popnames){ #converting files into 20kb merged windows
  ...
  for(f in c(5,7)){
    print(i)
    pops2[[i]][,j]<-slidecount(pops[[i]],as.numeric(pops[[i]][,j]),width=20,slide=1)
  }
}
