...
jpeg(filename="~/Documents/UCD/Projects/Adaptation + Introgression/draft/images/Ahr1a2a.jpg",width=1000,height=800)
...
jpeg(filename="~/Documents/UCD/Projects/Adaptation + Introgression/draft/images/Arnt_chr10.jpg",width=1000,height=800)
par(mfrow=c(5,1),mar=c(3,3,0,0),mgp=c(1,1,0))

for(i in 1:5){
  plot(pbsc10[20000:30000,i+3],pch=20,cex=.5,ylim=c(0,.6),bty='l',cex.axis=2,ylab='',xlab='', col="black")
  box(bty='l',lwd=3)
