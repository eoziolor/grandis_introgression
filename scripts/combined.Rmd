...
#cov<-read.table("~/analysis/data/angsd/cov_sub",header=TRUE,sep=',')
...
```{bash}
scp kodiak:/data/oziolore/fhet/data/angsd2/theta/*50kb* /home/elias/analysis/data/angsd/raw/
...
bb<-read.table("~/analysis/data/angsd/raw/BB_neut_50kb10kb.bed",stringsAsFactors=FALSE) #reading in all files
vb<-read.table("~/analysis/data/angsd/raw/VB_neut_50kb10kb.bed",stringsAsFactors=FALSE)
pb<-read.table("~/analysis/data/angsd/raw/PB_neut_50kb10kb.bed",stringsAsFactors=FALSE)
sj<-read.table("~/analysis/data/angsd/raw/SJ_neut_50kb10kb.bed",stringsAsFactors=FALSE)
bnp<-read.table("~/analysis/data/angsd/raw/BNP_neut_50kb10kb.bed",stringsAsFactors=FALSE)
sp<-read.table("~/analysis/data/angsd/raw/SP_neut_50kb10kb.bed",stringsAsFactors=FALSE)
gb<-read.table("~/analysis/data/angsd/raw/GB_neut_50kb10kb.bed",stringsAsFactors=FALSE)
