...
library(ape)
library(stringr)
vcf<-read.table("~/fgfh_post/data/fst/arnt_chr10_haplo.vcf.gz",stringsAsFactors = FALSE) #vcf that has been filtered out to only present one allele call per site per individual
