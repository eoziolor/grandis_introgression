...
jpeg(filename="~/Documents/UCD/Projects/Adaptation + Introgression/review/pbs_sum.jpg",width=1000,height=800)
pbsc$Scaf<-factor(pbsc$Scaf,levels=c("chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chr10",
                                     "chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18","chr19",
                                     "chr20","chr21","chr22","chr23","chr24"))
...
points(pbsc[,4],pch=20,cex=2,col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",mycol))))
     ...
     col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",
                            as.factor(pbsc[,1])))),
     xlab="",xaxt='n',cex.lab=1,cex.axis=3,bty="n",ylim=c(-.5,3.8),yaxs="i")
points(pbsc[,5],pch=20,cex=2,col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",mycol))))
     ...
     col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",
                              as.factor(pbsc[,1])))),
     xlab="",xaxt='n',cex.lab=1,cex.axis=3,bty="n",ylim=c(-.5,3.8),yaxs="i")
points(pbsc[,6],pch=20,cex=2,col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",mycol))))
     ...
     col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",
                              as.factor(pbsc[,1])))),
     xlab="",xaxt='n',cex.lab=1,cex.axis=3,bty="n",ylim=c(-.5,3.8),yaxs="i")
points(pbsc[,7],pch=20,cex=2,col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",mycol))))
     ...
     col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",
                              as.factor(pbsc[,1])))),
     xlab="",xaxt='n',cex.lab=1,cex.axis=3,bty="n",ylim=c(-.5,3.8),yaxs="i")
points(pbsc[,8],pch=20,cex=2,col=ifelse(pbsc[,"all"]>0,"purple",
                ifelse(pbsc[,"res"]>0,"black",
                       ifelse(pbsc[,"interm"]>0,"firebrick2",mycol))))
dev.off()
```
                                    ...
                                    ifelse(grepl("SJ",cname),"firebrick2",
                                           ifelse(grepl("BNP",cname),"firebrick2",
                                                  ifelse(grepl("SP",cname),"cadetblue3",
                                                         ifelse(grepl("GB",cname),"cadetblue3","seagreen3")))))))
popcol2<-ifelse(grepl("BB",cname),"black",
                      ifelse(grepl("VB",cname),"grey40",
                             ifelse(grepl("PB",cname),"grey80",
                                    ifelse(grepl("SJ",cname),"firebrick2",
                                           ifelse(grepl("BNP",cname),"lightpink",
                                                  ifelse(grepl("SP",cname),"cadetblue3",
                                                         ifelse(grepl("GB",cname),"cadetblue1","seagreen3")))))))              
...
popnamec<-c("black","black","black","firebrick1","firebrick1","cadetblue3","cadetblue3","seagreen3")
#distance matrix and nj tree
d <- t(gt) %>% dist()
#dd<-as.dist(ultrametric(d)) #imputing data for missing values using ultrametric procedure
mds <- cmdscale(d)
...
#plotting tree
jpeg(filename="~/Documents/UCD/Projects/Adaptation + Introgression/draft/images/arnt_chr10_NJ.jpg",width=400,height=1000)
plot(tr,"unrooted",show.tip.label=FALSE)
tiplabels(pch=20,col=popcol2,cex=1.2)
dev.off()

#plotting mds
jpeg(filename="~/Documents/UCD/Projects/Adaptation + Introgression/draft/images/arnt_chr10_MDS.jpg",width=1000,height=600)
par(mfrow=c(1,1),mar=c(3,3,0,0))
...
tiff("~/Documents/UCD/Projects/Adaptation + Introgression/draft/images/introgression_dxy.tiff",width=1200,height=600)
palette(c("grey40","grey80"))
