...
```{bash}
scp -P 2022 farm:/home/eoziolor/fgran/data/introgression/chr10_intr.vcf.bgz ~/analysis/data/intro_models/

zcat ~/analysis/data/intro_models/chr10_intr.vcf.bgz | ~/analysis/scripts/haplo/haploidize_gran_mine_large.r | gzip > ~/analysis/data/intro_models/chr10_intr_haplo.vcf.bgz
