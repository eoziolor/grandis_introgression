...
library(ape)
library(stringr)
vcf<-read.table("~/fgfh_post/data/fst/aqp3_chr24_haplo.vcf.gz",stringsAsFactors = FALSE) #vcf that has been filtered out to only present one allele call per site per individual
