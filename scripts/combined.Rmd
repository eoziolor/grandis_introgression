...
plot(sels18_scaled, maxCL_mig_stagSweeps.sels[18:31] - cl_neutral, 
     ...
     type = "l", col = "forestgreen", xlim = c(0, 1), xaxt = "none", xlab = "", lwd = 6, cex.lab = 1.1)
box(lwd=6)
lines(sels18_scaled, maxCL_sv.sels[18:31] - cl_neutral, col = "forestgreen", lwd = 6, lty = 2)
axis(1, at = seq(0, 1, length.out = 6), labels = seq(0.5, 1, length.out = 6), col = "forestgreen", lwd = 6, cex.axis = 2.8)
