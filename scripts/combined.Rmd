...
###Starting with small sample size for the plot of genome wide values
...
##Subtraction of pi and conversion to z statistic
...
## Grabbing those regions and putting them on pbs plots (for sum regions)
```{r}
...
## Grabbing those regions and putting them on pbs plots (for max regions)
...
jpeg(filename="~/backup/UCD/Projects/Adaptation + Introgression/draft/images/pbs.jpg",width=1000,height=800)
pbsc$Scaf<-factor(pbsc$Scaf,levels=c("chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chr10",
                                     "chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18","chr19",
                                     "chr20","chr21","chr22","chr23","chr24"))
palette(c("grey90","grey50"))
...
###Plotting Chr10/ARNT introgressed region----
...
* the function I am using to haploidize
...
## Looking at haploidized introgression region of CHR10
