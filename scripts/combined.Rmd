...
bb<-read.table("~/analysis/data/angsd/subsample/BB_neut_5kb1kb.bed",stringsAsFactors=FALSE) #reading in all files
vb<-read.table("~/analysis/data/angsd/subsample/VB_neut_5kb1kb.bed",stringsAsFactors=FALSE)
pb<-read.table("~/analysis/data/angsd/subsample/PB_neut_5kb1kb.bed",stringsAsFactors=FALSE)
sj<-read.table("~/analysis/data/angsd/subsample/SJ_neut_5kb1kb.bed",stringsAsFactors=FALSE)
bnp<-read.table("~/analysis/data/angsd/subsample/BNP_neut_5kb1kb.bed",stringsAsFactors=FALSE)
sp<-read.table("~/analysis/data/angsd/subsample/SP_neut_5kb1kb.bed",stringsAsFactors=FALSE)
gb<-read.table("~/analysis/data/angsd/subsample/GB_neut_5kb1kb.bed",stringsAsFactors=FALSE)
