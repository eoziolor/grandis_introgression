...
-g <(cut -f 1-2 ~/analysis/data/genome/unsplit_merge.fasta.fai) > ~/analysis/data/fst/PBSoutliers_50kb_all.bed
...
read.table("~/analysis/data/fst/PBSoutliers_50kb_all.bed",stringsAsFactors=FALSE)->PBSout
